...
class BaseCluster {
    ...
    async init() {
        ...
        this.client.on('shardDisconnect', ({ code, reason, wasClean }, id) => shardUtil.send({ op: Constants_1.IPCEvents.SHARDDISCONNECT, d: { id: this.id, shardID: id, closeEvent: { code, reason, wasClean } } }, { receptive: false }));
        await this.launch();
    }
}
